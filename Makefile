#############################################################################
# Makefile for building: audio-output
# Generated by qmake (3.1) (Qt 5.11.1)
# Project:  audio-output.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile audio-output.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = audio-output1.0.0
DISTDIR = /home/chris/Programmeren/sailfish/audio-output/.tmp/audio-output1.0.0
LINK          = g++
...
OBJECTS       = audio-output.o
DIST          = qml/audio-output.qml \
		...
		audio-output.pro  src/audio-output.cpp
QMAKE_TARGET  = audio-output
DESTDIR       = 
TARGET        = audio-output
...
Makefile: audio-output.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile audio-output.pro
/usr/lib/qt/mkspecs/features/spec_pre.prf:
/usr/lib/qt/mkspecs/common/unix.conf:
/usr/lib/qt/mkspecs/common/linux.conf:
/usr/lib/qt/mkspecs/common/sanitize.conf:
...
distdir: FORCE
	...
	$(COPY_FILE) --parents src/audio-output.cpp $(DISTDIR)/
	$(COPY_FILE) --parents translations/audio-output-de.ts $(DISTDIR)/
...
compiler_moc_source_make_all: audio-output.moc
compiler_moc_source_clean:
	-$(DEL_FILE) audio-output.moc
audio-output.moc: src/audio-output.cpp \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/home/chris/Programmeren/sailfish/audio-output -I/usr/include/qt -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/8.2.1 -I/usr/include/c++/8.2.1/x86_64-pc-linux-gnu -I/usr/include/c++/8.2.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/8.2.1/include-fixed -I/usr/include src/audio-output.cpp -o audio-output.moc
...
audio-output.o: src/audio-output.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o audio-output.o src/audio-output.cpp
